...
uses
  System.IOUtils, fmx.Objects, fmx.Graphics, Objekt.PhotoOrga, System.TypInfo, fmx.Types;
...
begin
 ...
 // SearchDirectories(s);
  ...
  s := '/storage/9C33-6BBD/DCIM/Camera';
  SearchDirectories(s);
...
begin
  ...
  begin
    ...
    begin
      log.d(IntToStr(i1) + ' - ' + Filename);
      if Assigned(fOnProgress) then
        fOnProgress(i1+1, Filename);
       // fOnProgress(i1+1, IntToStr(i1) + ' ' + Filename);
    end;
  end;
end;
