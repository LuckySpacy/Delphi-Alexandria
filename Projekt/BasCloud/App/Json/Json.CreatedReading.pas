...
type
  ...
  public
    ...
    destructor Destroy; override;
    function ToJsonString: string;
    class function FromJsonString(AJsonString: string): TJCreatedReading;
  end;
...
constructor TJCreatedReading.Create;
begin
  inherited;
  FData := TDataClass.Create();
end;

destructor TJCreatedReading.Destroy;
begin
  FData.free;
  inherited;
end;

function TJCreatedReading.ToJsonString: string;
begin
  result := TJson.ObjectToJsonString(self);
end;

class function TJCreatedReading.FromJsonString(AJsonString: string): TJCreatedReading;
begin
  result := TJson.JsonToObject<TJCreatedReading>(AJsonString);
end;
